...
// External functions to do stuff
extern int liballoc_lock();
extern int liballoc_unlock();
extern void* liballoc_alloc(size_t pages);
extern int liballoc_free(void *mem, size_t pages);
...
void *lalloc_malloc(size_t req_size) {
	int startedBet = 0;
...
void* lalloc_calloc(size_t nobj, size_t size) {
	int real_size;
	void *p;
...
void* lalloc_realloc(void *p, size_t size) {
	void *ptr;
	struct liballoc_minor *min;
